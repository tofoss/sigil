...
- `VITE_BASE_PATH` - Base path for application deployment (default: `/`)
  - Use `/` for root deployment (e.g., `https://example.com/`)
  - Use `/sigil/` for subdirectory deployment (e.g., `https://example.com/sigil/`)
  - The base path affects both asset URLs and application routing
